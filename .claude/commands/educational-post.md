...
### 3. Generate images via Google Gemini (Nano Banana Pro)
...
# (no more cropping/composing the header). It also renders in-image text very well,
# which is ideal for these infographic/cheatsheet visuals.
